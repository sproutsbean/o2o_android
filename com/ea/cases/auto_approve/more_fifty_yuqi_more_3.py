...
"""24个月以内借款人和配偶合计逾期次数超过3次"""


class MyTestCase(unittest.TestCase):
    u"""申请金额60万,营业执照注册时间为:2012-01-01,已婚,借款人32岁,配偶32岁,年销售额810万,无信贷纠纷,借款人”24个月内逾期次数”2次,配偶”24个月内逾期次数”2次"""
    ...
    def test_d_loan_approve(self):
        """审批贷款"""
        zx_zongfuzai_yue = "0"
        daikuan_yuqi_cishu = "2"
        daikuan_yuqi_24_wai = "0"
        danbao_yue = "0"
        xinyongka_yuqi_cishu = "0"
        pzx_zongfuzai_yue = "0"
        pdaikuan_yuqi_cishu = "2"
        pdaikuan_yuqi_24_wai = "0"
        pdanbao_yue = "0"
        pxinyongka_yuqi_cishu = "0"
        # self.loan_no = "CMY000001-BK-1803-00012"
        web_loan.loan_approve(self.webdriver, self.loanno, self.marry_status, self.screenshot_path, daikuan_yuqi_cishu=daikuan_yuqi_cishu, pdaikuan_yuqi_cishu=pdaikuan_yuqi_cishu)
