...
"""未婚,借款人夫妻双方家庭负债余额超过300万"""


class MyTestCase(unittest.TestCase):
    u"""年销售额200万,申请金额15万,ea批复额度15万,与其他人不存在担保关系,借款人”联保贷款余额”为0,借款人”剔除房/车贷之后的征信总负债余额”为210万,”对外担保余额”为200万,未婚"""
    ...
    def test_d_loan_approve(self):
        ...
        web_loan.loan_approve(self.webdriver, self.loanno, self.marry_status, self.screenshot_path, zx_zongfuzai_yue=zx_zongfuzai_yue)
