...
class MyTestCase(unittest.TestCase):
    u"""年销售额700万,”联保贷款余额”为0,借款人”剔除房/车贷之后的征信总负债余额”为210万”,配偶”剔除房/车贷之后的征信总负债余额”为100万”,
    申请金额60万,营业起始时间为:2012-01-01,已婚,借款人32岁,配偶32岁,无信贷纠纷,借款人”24个月内逾期次数”0次,配偶”24个月内逾期次数”0次,借款人”24个月外逾期次数”0次,配偶”24个月外逾期次数”0次"""
    ...
    def test_d_loan_approve(self):
        """审批贷款"""
        zx_zongfuzai_yue = "210"
        daikuan_yuqi_cishu = "0"
        daikuan_yuqi_24_wai = "0"
        danbao_yue = "0"
        xinyongka_yuqi_cishu = "0"
        pzx_zongfuzai_yue = "100"
        pdaikuan_yuqi_cishu = "0"
        pdaikuan_yuqi_24_wai = "0"
        pdanbao_yue = "0"
        pxinyongka_yuqi_cishu = "0"
        # self.loan_no = "CMY000001-BK-1803-00012"
        web_loan.loan_approve(self.webdriver, self.loanno, self.marry_status, self.screenshot_path, zx_zongfuzai_yue=zx_zongfuzai_yue, pzx_zongfuzai_yue=pzx_zongfuzai_yue)
