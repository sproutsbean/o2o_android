...
"""24个月外借款人与配偶合计逾期次数超过5次"""


class MyTestCase(unittest.TestCase):
    u"""申请金额60万,营业执照注册时间为:2012-01-01,已婚,借款人32岁,配偶32岁,年销售额810万,无信贷纠纷,借款人”24个月内逾期次数”0次,配偶”24个月内逾期次数”0次,借款人”24个月外逾期次数”3次,配偶”24个月外逾期次数”3次"""
    ...
    def test_a_loan_apply(self):
        """申请贷款"""
        card_no, fullname, partner_zx_no = loan.loan_zhengxin_apply(self.driver, self.loan_type, self.sumofmoney, self.bank_name, self.operate_mode, self.screenshot_path, marry_status=self.marry_status, start_date='1968-01-01',
                                                                    end_date='1988-12-30')
    ...
    def test_d_loan_approve(self):
        ...
        daikuan_yuqi_24_wai = "3"
        danbao_yue = "0"
        xinyongka_yuqi_cishu = "0"
        pzx_zongfuzai_yue = "0"
        pdaikuan_yuqi_cishu = "0"
        pdaikuan_yuqi_24_wai = "3"
        pdanbao_yue = "0"
        pxinyongka_yuqi_cishu = "0"
        # self.loan_no = "CMY000001-BK-1803-00012"
        web_loan.loan_approve(self.webdriver, self.loanno, self.marry_status, self.screenshot_path, daikuan_yuqi_24_wai=daikuan_yuqi_24_wai, pdaikuan_yuqi_24_wai=pdaikuan_yuqi_24_wai)
    ...
    def test_f_inside_approve(self):
        u"""审批内部审批"""
        # self.loanno = 'YN010-BP-1809-00020'
