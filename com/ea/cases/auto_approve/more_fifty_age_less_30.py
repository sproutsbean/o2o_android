...
class MyTestCase(unittest.TestCase):
    u"""申请金额60万,营业执照注册时间为:2012-01-01,已婚,借款人28岁,配偶32岁"""
    ...
    def test_a_loan_apply(self):
        """申请贷款"""
        card_no, fullname, partner_zx_no = loan.loan_zhengxin_apply(self.driver, self.loan_type, self.sumofmoney, self.bank_name, self.operate_mode, self.screenshot_path, marry_status=self.marry_status, start_date='1993-01-01',
                                                                    end_date='1993-12-30')
