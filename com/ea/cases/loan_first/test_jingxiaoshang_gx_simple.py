...
class MyTestCase(unittest.TestCase):
    ...
    def test_a_loan_apply(self):
        ...
        MyTestCase.loanno, MyTestCase.partner_zx_no = loan.loan_zhengxin_apply(self.driver, self.loan_type, self.cardNo, self.first_name, self.second_name, self.first_english_name, self.last_english_name, self.phoneNo, gl.xd_manager_name, sumofmoney,
                                                     self.operate_mode, channel_name, self.screenshot_path, casename,marry_status=self.marry_status)
    ...
    def test_j_interview_approve(self):
        ...
        casename = sys._getframe().f_code.co_name
        # self.fullname = "伏兴桌"
        self.loanno = "HEN070-BP_JX-1806-00001"
