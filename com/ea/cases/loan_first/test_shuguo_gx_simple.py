...
class MyTestCase(unittest.TestCase):
    ...
    def test_e_edit_inside_apply(self):
        ...
        # self.loanno = "SK0027-SG-1712-00004"
        print("开始编辑内部审批")
        ...
        try:
            ...
            time.sleep(2)
            # 编辑渠道数据
            insidepage.scroll_to_fruits_channel()
            insidepage.input_startoperatetime(startoperatetime)
            insidepage.select_isParking(isparking)
            # 编辑上游信息
            insidepage.scroll_to_fruits_shangyouxinxi()
            insidepage.select_isOwnFarm(isownfarm)
            insidepage.select_isFarmer(isfarmer)
            insidepage.select_isOtherPurchase(isotherpurchase)
            insidepage.select_farme_address_province(province)
            insidepage.select_farme_address_city(city)
            insidepage.input_farme_address_road(road)
            insidepage.input_othermode(othermode)
            # 编辑下游信息
            insidepage.scroll_to_fruits_xiayouxinxi()
            insidepage.input_twobatch(twobatch)
            insidepage.input_supermarket(supermarket)
            insidepage.input_groupPurch(grouppurch)
            insidepage.input_retail(retail)
            insidepage.click_fruits_save_button()
            time.sleep(1)
            # 增加主要产品销售情况
            insidepage.scroll_to_fruits_zhuyaoxiaoshouchanpin()
            insidepage.click_fruits_main_product_add()
            insidepage.input_fruits_product_name(fruits_product_name)
            insidepage.click_fruits_chandi()
            insidepage.input_last_six_month_sales(last_six_month_sales)
            insidepage.click_fruits_main_product_save()
            time.sleep(1)
            # 编辑调查结论
    ...
    #     shuguo_chanpinmingchen = "荔枝"
    #     shuguo_shangyuexiaoliang = "10000"
    #     ziyounongchangdizhi = "农场一路"
    ...
    #         insidepage.click_add_button()
    #         insidepage.select_shichangjingyingkaishishijian()
    #         insidepage.select_dangkouyouwuchewei()
    #         insidepage.click_save_button()
    #         time.sleep(2)
    #         self.driver.back()
    #         # 上游信息
    #         insidepage.click_shangyouxinxi()
    #         insidepage.click_imgview()
    #         insidepage.select_shifouziyounongchang()
    #         insidepage.input_ziyounongchangdizhi(ziyounongchangdizhi)
    #         insidepage.select_shifouxianggudingnonghucaigou()
    #         insidepage.select_shifouxiangqitagongyingshangcaigou()
    #         insidepage.click_save_button()
    #         time.sleep(2)
    #         self.driver.back()
    #         # 下游信息
    #         insidepage.click_xiayouxinxi()
    #         insidepage.click_imgview()
    #         insidepage.input_shuguo_erpishang(erpishang)
    #         insidepage.input_shuguo_shangchao(shangchao)
    #         insidepage.input_shuguo_lingshouzhongduan(lingshouzhongduan)
    #         insidepage.input_shuguo_tuangou(lingshouzhongduan)
    #         insidepage.click_save_button()
    #         time.sleep(2)
    #         self.driver.back()
    #         # 主要销售产品
    ...
    #         insidepage.click_add_button()
    #         insidepage.input_shuguo_chanpinmingchen(shuguo_chanpinmingchen)
    #         insidepage.select_chandi()
    #         insidepage.input_shuguo_shangyuexiaoliang(shuguo_shangyuexiaoliang)
    #         insidepage.click_save_button()
    #         time.sleep(2)
    #         self.driver.back()
    #         time.sleep(1)
