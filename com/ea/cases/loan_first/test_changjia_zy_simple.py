...
class MyTestCase(unittest.TestCase):
    ...
    def test_e_edit_inside_apply(self):
        ...
        yuqudaoqiyehezuoqishishijian = "2018-01-01"
        supplier = "贵州茅台"
        hezuo_product = "飞天茅台"
        caigouzhanbi = "50"
        zhangqi = "30"
        ...
        try:
            ...
            webinsidepage.select_loan_bankname(bankname)
            # webinsidepage.select_tuijian_type(tuijian_type)
            # webinsidepage.input_tuijian_name(tuijian_name)
    ...
    def test_g_pay_money_apply(self):
        ...
        casename = sys._getframe().f_code.co_name
        # self.fullname = "奚男遗"
        # self.cardNo = "341723198006161314"
