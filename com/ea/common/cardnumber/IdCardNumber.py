...
def getRandomIdNumber(sex=1, start="1968-01-01", end="1988-12-30"):
    ...
    idNumber = str(addrId)
    # 出生日期码
    # start, end = "1960-01-01","1991-12-30" #生日起止日期
    # start, end = "1991-01-01", "1991-12-30"  # 生日起止日期
    # start, end = "1966-01-01", "1966-12-30"  # 生日起止日期
    # start, end = "1968-01-01", "1988-12-30"  # 生日起止日期
    start, end = start, end
